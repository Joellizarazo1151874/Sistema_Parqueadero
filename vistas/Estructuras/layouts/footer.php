 ...
 <footer class="pc-footer">
    <div class="footer-container">
        <div class="button-group">
            ...
            <button class="btn btn-custom btn-lightblue" data-bs-toggle="modal" data-bs-target="#motoModal">MOTO</button>
            <button class="btn btn-custom btn-lightblue" data-bs-toggle="modal" data-bs-target="#autoModal">AUTO</button>
            <button class="btn btn-custom btn-lightblue" data-bs-toggle="modal" data-bs-target="#camionetaModal">CAMIONETA</button>
            <button class="btn btn-custom btn-lightblue" data-bs-toggle="modal" data-bs-target="#motocarroModal">MOTOCARRO</button>
        </div>
    </div>
</footer>
